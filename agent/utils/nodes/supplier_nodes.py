...
def find_suppliers_node(state: ProcurementState) -> ProcurementState:
    ...
    for proposal in deduped_proposals:
        ...
        supplier_selections.append({
            ...
            'order_path': proposal.get('order_path', 'suppliers'),
            'release_date': proposal.get('release_date') or product.get('release_date'),
            'created_at': proposal.get('created_at') or product.get('created_at'),
            'market_popularity_score': proposal.get('market_popularity_score') or product.get('market_popularity_score'),
